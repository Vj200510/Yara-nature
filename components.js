...
(function injectSharedComponents() {
  ...
  function initScrollTop() {
    ...
    btn.innerHTML = '<svg width="18" height="18" fill="none" stroke="#fff" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="18 15 12 9 6 15"/></svg>';
  ...
  function initFloatingWa() {
    ...
    /* Use CSS class — positioned above sticky bar via CSS var(--sticky-h) */
